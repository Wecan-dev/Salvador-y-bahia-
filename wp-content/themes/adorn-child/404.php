					...
					<div class="edge-page-not-found">
						...
						<p class="edge-page-not-found-text">
							<?php if(!empty($edge_text_404)){
								...
								esc_html_e('No se pudo encontrar la página solicitada. Esto podría ser un error ortográfico en la URL o una página eliminada.', 'adorn');
							} ?>
						</p>

						<?php
							$edge_params = array();
							$edge_params['text'] = !empty($edge_button_label) ? $edge_button_label : esc_html__('Volver al inicio', 'adorn');
